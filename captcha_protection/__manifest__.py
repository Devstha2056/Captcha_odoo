...
* Contact Us and the Helpdesk ticket form:
  ...
  - v2: our own checkbox widget is inserted directly into those two page
    templates (website_innovax.contactus_innovax /
    website_helpdesk.ticket_submit_form), since the builder's own JS has
    no v2 code path at all
""",
    "version": "19.0.1.0.0",
    "category": "Extra Tools",
    "author": "Grantha Network",
    "license": "LGPL-3",
    "depends": ["auth_signup", "google_recaptcha", "website_innovax", "website_helpdesk"],
    "data": [
